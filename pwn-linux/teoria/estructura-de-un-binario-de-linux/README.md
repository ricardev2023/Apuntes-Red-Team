...
## ESTRUCTURA DEL FORMATO ELF <a id="layout-del-formato-elf-executable-and-linking-format-de-gnulinux"></a>
...
### Global Offset Table \(GOT\) <a id="global-offset-table-got"></a>
...
### Enlazado dinámico de binarios <a id="enlazado-din&#xE1;mico-de-binarios"></a>
...
#### _Procedure Lookup Table_ o PLT <a id="procedure-lookup-table-o-plt"></a>
...
### La utilidad de la GOT <a id="la-utilidad-de-la-got"></a>
...
2. **En una lectura arbitraria**  
   ...
   Pero la dirección de las entradas en la GOT es fija -sin ninguna mitigación extra como una compilación con [PIE](https://en.wikipedia.org/wiki/Position-independent_code#PIE) por ejemplo- y por lo tanto idéntica en cada ejecución.
