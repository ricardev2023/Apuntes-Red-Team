...
## LLAMADAS AL SISTEMA <a href="#llamadas-al-sistema" id="llamadas-al-sistema"></a>
...
### Syscall write: <a href="#syscall-write" id="syscall-write"></a>
...
### Syscall exit: <a href="#syscall-exit" id="syscall-exit"></a>
...
### Syscall execve: <a href="#syscall-execve" id="syscall-execve"></a>
...
### Ensamblar y linkear <a href="#ensamblar-y-linkear" id="ensamblar-y-linkear"></a>
...
## SHELLCODE <a href="#shellcode" id="shellcode"></a>
...
### Programar un shellcode <a href="#programar-un-shellcode" id="programar-un-shellcode"></a>
...
#### Estrategias para crear un shellcode inyectable dentro de un programa vulnerable: <a href="#estrategias-para-crear-un-shellcode-inyectable-dentro-de-un-programa-vulnerable" id="estrategias-para-crear-un-shellcode-inyectable-dentro-de-un-programa-vulnerable"></a>
...
#### Shellcode que imprime “you win!” <a href="#shellcode-que-imprime-you-win" id="shellcode-que-imprime-you-win"></a>
...
#### Shellcode para lograr una shell <a href="#shellcode-para-lograr-una-shell" id="shellcode-para-lograr-una-shell"></a>
...
### Tobogán de NOPs <a href="#tobogan-de-nops" id="tobogan-de-nops"></a>
