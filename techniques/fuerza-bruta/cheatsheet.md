---
description: A continuación veremos un resumen de lo visto anteriormente.
---

# CHEATSHEET

{% embed url="https://book.hacktricks.xyz/brute-force" %}
Fuente
{% endembed %}
...
{% embed url="https://github.com/LandGrey/pydictor" %}
pyDictor
{% endembed %}
...
Para http**s** tienes que cambiar "`http-post-form`" a "**`https-post-form`"**
...
Para usar **oracle\_login** con **patator** tienes que **instalar**:
...
{% embed url="https://http.kali.org/pool/main/t/thc-pptp-bruter" %}
pptc bruter
{% endembed %}
